      ...
      <div className="space-y-6 max-w-[1600px] mx-auto p-2 relative">
        ...
        <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div className="flex items-center gap-4">
            <div className="w-11 h-11 bg-slate-900 border border-slate-800 rounded-xl flex items-center justify-center shadow-sm">
              <UserMinus size={20} className="text-white" />
            </div>
            <div>
              <h2 className="text-xl font-black text-slate-800 tracking-tight">Termination Letter Management</h2>
              <p className="text-xs text-slate-400 font-bold mt-1">Issue official termination letters and dispatch notifications directly to employees</p>
            </div>
          </div>
