...
import { Calculator, FileText, Landmark, Clock, ArrowRight, Play, CheckCircle } from "lucide-react";
        ...
        <div className="relative max-w-7xl mx-auto px-6 lg:px-10">
          <div className="flex flex-col lg:flex-row items-center gap-16">
            ...
            <div className="lg:w-1/2 z-10">
              ...
              >
                Run your entire company's payroll in minutes, not days. Automate complex calculations, tax deductions, and statutory compliance with zero errors.
              </motion.p>
            ...
            >
              ...
              <div className="relative rounded-2xl shadow-[0_32px_80px_rgba(16,185,129,0.12),0_8px_32px_rgba(0,0,0,0.08)] overflow-hidden border border-slate-200/80 bg-white">
      ...
      <section className="py-24 bg-white relative">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-10 relative">
          ...
          <motion.div {...fadeUp()} className="text-center max-w-2xl mx-auto mb-20">
            <h2 className="text-4xl font-black text-slate-900 tracking-tight mb-5">Pay your team accurately, every time</h2>
            <p className="text-lg text-slate-500 leading-relaxed">No more spreadsheets or calculator errors. Zenova handles the heavy lifting so you can run payroll with confidence.</p>
          </motion.div>

          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-7">
            {[
              { icon: Calculator, title: "Automated Calculations", desc: "Instantly calculate basic pay, allowances, overtime, and deductions based on attendance." },
              { icon: Landmark, title: "Statutory Compliance", desc: "Auto-calculate PF, PT, ESI, and TDS. Stay compliant with constantly changing tax laws." },
              { icon: FileText, title: "Bulk Payslips", desc: "Generate and email digital payslips to all employees simultaneously with one click." },
              { icon: Clock, title: "Leave Integration", desc: "Seamlessly pulls leave without pay (LWP) and half-day data directly from the attendance module." },
            ].map((feature, i) => (
              <motion.div
                key={i}
                {...fadeUp(i * 0.1)}
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-10 space-y-32">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            <div className="lg:w-1/2">
              <motion.h2 {...fadeUp()} className="text-3xl lg:text-4xl font-black text-slate-900 mb-6 tracking-tight">Flexible Salary Components</motion.h2>
              <motion.p {...fadeUp(0.1)} className="text-lg text-slate-500 leading-relaxed mb-8">
                Every business is different. Build customized salary structures with fixed, variable, or conditional components tailored to your organizational needs.
              </motion.p>
          ...
          <div className="flex flex-col lg:flex-row-reverse items-center gap-16">
            <div className="lg:w-1/2">
              <motion.h2 {...fadeUp()} className="text-3xl lg:text-4xl font-black text-slate-900 mb-6 tracking-tight">Direct Bank Transfers</motion.h2>
              <motion.p {...fadeUp(0.1)} className="text-lg text-slate-500 leading-relaxed mb-8">
                Eliminate the manual work of uploading bank files. Export universally accepted bank transfer formats or integrate directly with your corporate banking portal.
              </motion.p>
              <ul className="space-y-4">
                {[
                  "Export standard bank formats (NEFT/RTGS)",
                  "Maker-checker approval workflows",
                  "Detailed payroll disbursement reports"
                ].map((text, i) => (
                  <motion.li key={i} {...fadeUp(0.2 + (i * 0.1))} className="flex items-center gap-3">
                    <CheckCircle className="text-blue-500 w-5 h-5 shrink-0" />
                    <span className="text-slate-700 font-medium">{text}</span>
      ...
      <section className="relative overflow-hidden bg-white py-24 border-t border-slate-100">
        ...
        <div className="max-w-4xl mx-auto px-6 lg:px-10 text-center relative">
          ...
          <motion.p {...fadeUp(0.1)} className="text-xl text-slate-500 mb-10">
            Run your next payroll in minutes with 100% accuracy and compliance.
          </motion.p>
