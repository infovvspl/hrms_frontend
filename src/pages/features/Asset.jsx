...
import { Laptop, MonitorSmartphone, QrCode, ShieldAlert, CheckCircle, ArrowRight, Play } from "lucide-react";
        ...
        <div className="relative max-w-7xl mx-auto px-6 lg:px-10">
          <div className="flex flex-col lg:flex-row items-center gap-16">
            ...
            <div className="lg:w-1/2 z-10">
              ...
              >
                Total control over your IT inventory.
              </motion.h1>
              ...
              >
                Never lose track of a laptop again. Manage assignments, software licenses, warranties, and the full lifecycle of every piece of hardware in your organization.
              </motion.p>
            ...
            >
              ...
              <div className="relative rounded-2xl shadow-[0_32px_80px_rgba(2,132,199,0.12),0_8px_32px_rgba(0,0,0,0.08)] overflow-hidden border border-slate-200/80 bg-white">
      ...
      <section className="py-24 bg-white relative">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-10 relative">
          ...
          <motion.div {...fadeUp()} className="text-center max-w-2xl mx-auto mb-20">
            <h2 className="text-4xl font-black text-slate-900 tracking-tight mb-5">A unified registry for all your company assets</h2>
            <p className="text-lg text-slate-500 leading-relaxed">Equip your IT and HR teams with the tools they need to track, maintain, and secure company property.</p>
          </motion.div>

          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-7">
            {[
              { icon: MonitorSmartphone, title: "Inventory Tracking", desc: "Keep a centralized registry of all hardware and software. Track stock levels across different branches." },
              { icon: Laptop, title: "Lifecycle Management", desc: "Manage the entire lifecycle from procurement to assignment, maintenance, and safe disposal." },
              { icon: QrCode, title: "QR Code Tagging", desc: "Generate QR codes for physical assets. Scan them with any mobile device to view details instantly." },
              { icon: ShieldAlert, title: "Warranty Alerts", desc: "Get automated notifications before warranties expire or when routine maintenance is due." },
            ].map((feature, i) => (
              <motion.div
                key={i}
                {...fadeUp(i * 0.1)}
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-10 space-y-32">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            <div className="lg:w-1/2">
              <motion.h2 {...fadeUp()} className="text-3xl lg:text-4xl font-black text-slate-900 mb-6 tracking-tight">Seamless Onboarding & Offboarding</motion.h2>
              <motion.p {...fadeUp(0.1)} className="text-lg text-slate-500 leading-relaxed mb-8">
                Ensure new hires get their equipment on day one. When an employee leaves, Zenova automatically generates a checklist of items they need to return, preventing loss of expensive hardware.
              </motion.p>
              <ul className="space-y-4">
                {[
                  "Digital acceptance signatures from employees",
                  "Automated recovery checklists",
                  "Damage reporting and penalty deductions"
                ].map((text, i) => (
            ...
            >
              ...
              <img 
                ...
                alt="IT Support preparing laptops" 
          ...
          <div className="flex flex-col lg:flex-row-reverse items-center gap-16">
            <div className="lg:w-1/2">
              <motion.h2 {...fadeUp()} className="text-3xl lg:text-4xl font-black text-slate-900 mb-6 tracking-tight">Software License Management</motion.h2>
              <motion.p {...fadeUp(0.1)} className="text-lg text-slate-500 leading-relaxed mb-8">
                Stop paying for unused SaaS subscriptions. Track every software license assigned to your employees and get alerts before renewals are charged to your corporate card.
              </motion.p>
              <ul className="space-y-4">
                {[
                  "Track per-seat license allocations",
                  "Identify underutilized software",
                  "Centralized vendor contract storage"
                ].map((text, i) => (
                  <motion.li key={i} {...fadeUp(0.2 + (i * 0.1))} className="flex items-center gap-3">
                    <CheckCircle className="text-blue-500 w-5 h-5 shrink-0" />
                    <span className="text-slate-700 font-medium">{text}</span>
            ...
            >
              ...
              <img 
                ...
                alt="Software Management Dashboard" 
                className="relative rounded-[2rem] shadow-2xl border border-slate-200/60 object-cover w-full h-auto"
              />
            </motion.div>
          </div>
      ...
      <section className="relative overflow-hidden bg-white py-24 border-t border-slate-100">
        ...
        <div className="max-w-4xl mx-auto px-6 lg:px-10 text-center relative">
          ...
          <motion.p {...fadeUp(0.1)} className="text-xl text-slate-500 mb-10">
            Eliminate spreadsheets and shadow IT. Keep a pristine record of what you own.
          </motion.p>
