      ...
      <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-16 items-center">
        ...
        >
          ...
          <p className="mt-5 text-lg text-gray-600 leading-relaxed">
            Track, assign, and manage all company assets like laptops,
            devices, and equipment with full lifecycle visibility.
          </p>
          ...
          <div className="mt-10 space-y-4">
            ...
            {[
              { text: "Asset allocation to employees", icon: "🧑‍💻" },
              { text: "Real-time asset tracking", icon: "📍" },
              { text: "Maintenance history logs", icon: "🔧" },
              { text: "Return & audit tracking", icon: "📦" },
            ].map((item, i) => (
              <motion.div
                key={i}
        ...
        >
          ...
          {/* GLOW */}
          <div className="absolute w-[90%] h-[90%] bg-cyan-400/20 blur-[120px] rounded-full" />

          {/* STACKED DEVICE CARDS DESIGN */}
          <div className="relative w-full max-w-md">

            {/* BACK CARD */}
            <div className="absolute top-6 left-6 w-full h-full bg-blue-100 rounded-[30px] rotate-[-6deg]"></div>
