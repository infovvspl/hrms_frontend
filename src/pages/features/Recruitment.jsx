...
import { UserPlus, Briefcase, Calendar, Star, ArrowRight, Play, CheckCircle } from "lucide-react";
        ...
        <div className="relative max-w-7xl mx-auto px-6 lg:px-10">
          <div className="flex flex-col lg:flex-row items-center gap-16">
            ...
            <div className="lg:w-1/2 z-10">
              ...
              >
                Manage your entire hiring pipeline—from job posting to candidate selection—with a fully automated applicant tracking system (ATS).
              </motion.p>
            ...
            >
              ...
              <div className="relative rounded-2xl shadow-[0_32px_80px_rgba(249,115,22,0.12),0_8px_32px_rgba(0,0,0,0.08)] overflow-hidden border border-slate-200/80 bg-white">
      ...
      <section className="py-24 bg-white relative">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-10 relative">
          ...
          <motion.div {...fadeUp()} className="text-center max-w-2xl mx-auto mb-20">
            <h2 className="text-4xl font-black text-slate-900 tracking-tight mb-5">Everything you need to hire the best</h2>
            <p className="text-lg text-slate-500 leading-relaxed">Streamline your entire talent acquisition process from job requisition to offer rollout.</p>
          </motion.div>

          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-7">
            {[
              { icon: Briefcase, title: "Job Board Parsing", desc: "Post to multiple job boards and parse incoming resumes automatically into standard profiles." },
              { icon: Calendar, title: "Interview Scheduling", desc: "Automate calendar invites for candidates and interviewers with built-in video links." },
              { icon: Star, title: "Evaluation Scorecards", desc: "Standardize your hiring process with custom evaluation metrics and feedback forms." },
              { icon: UserPlus, title: "Seamless Onboarding", desc: "Convert candidates to employees instantly and automatically trigger the onboarding workflow." },
            ].map((feature, i) => (
              <motion.div
                key={i}
                {...fadeUp(i * 0.1)}
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-10 space-y-32">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            <div className="lg:w-1/2">
              <motion.h2 {...fadeUp()} className="text-3xl lg:text-4xl font-black text-slate-900 mb-6 tracking-tight">Custom Hiring Pipelines</motion.h2>
              <motion.p {...fadeUp(0.1)} className="text-lg text-slate-500 leading-relaxed mb-8">
                Not every role follows the same interview process. Create distinct hiring pipelines for different roles, from entry-level positions to executive searches.
              </motion.p>
              <ul className="space-y-4">
                {[
                  "Drag-and-drop Kanban view",
                  "Automated stage-change emails",
                  "Collaborative notes for hiring managers"
                ].map((text, i) => (
            ...
            >
              ...
              <img 
                ...
                alt="Colleagues discussing candidates" 
          ...
          <div className="flex flex-col lg:flex-row-reverse items-center gap-16">
            <div className="lg:w-1/2">
              <motion.h2 {...fadeUp()} className="text-3xl lg:text-4xl font-black text-slate-900 mb-6 tracking-tight">Automated Offer Generation</motion.h2>
              <motion.p {...fadeUp(0.1)} className="text-lg text-slate-500 leading-relaxed mb-8">
                Once a candidate is selected, automatically generate customized offer letters based on their profile, approved salary, and standard company templates.
              </motion.p>
              <ul className="space-y-4">
                {[
      ...
      <section className="relative overflow-hidden bg-white py-24 border-t border-slate-100">
        ...
        <div className="max-w-4xl mx-auto px-6 lg:px-10 text-center relative">
          ...
          <motion.p {...fadeUp(0.1)} className="text-xl text-slate-500 mb-10">
            Streamline your recruitment process and give candidates a world-class experience.
          </motion.p>
