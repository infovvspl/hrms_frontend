...
import { Users, Shield, Database, Search, ArrowRight, Play, CheckCircle } from "lucide-react";
        ...
        <div className="relative max-w-7xl mx-auto px-6 lg:px-10">
          <div className="flex flex-col lg:flex-row items-center gap-16">
            ...
            <div className="lg:w-1/2 z-10">
              ...
              >
                Say goodbye to scattered spreadsheets. Centralize employee data, automate onboarding, and build a connected workplace with our intuitive platform.
              </motion.p>
            ...
            >
              ...
              <div className="relative rounded-2xl shadow-[0_32px_80px_rgba(59,130,246,0.12),0_8px_32px_rgba(0,0,0,0.08)] overflow-hidden border border-slate-200/80 bg-white">
      ...
      <section className="py-24 bg-white relative">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-10 relative">
          ...
          <motion.div {...fadeUp()} className="text-center max-w-2xl mx-auto mb-20">
            <h2 className="text-4xl font-black text-slate-900 tracking-tight mb-5">Everything you need to manage your team</h2>
            <p className="text-lg text-slate-500 leading-relaxed">Empower your HR department with tools designed to reduce administrative overhead and improve data accuracy.</p>
          </motion.div>

          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-7">
            {/* Feature Cards matching Home theme */}
            {[
              { icon: Database, title: "Centralized Directory", desc: "Store all employee details in one secure database. Easily search and update records." },
              { icon: Shield, title: "Role-based Access", desc: "Ensure data privacy by granting precise permissions based on job roles and departments." },
              { icon: Users, title: "Self-Service Portal", desc: "Allow employees to update their personal info, view pay slips, and request leaves." },
              { icon: Search, title: "Advanced Search", desc: "Find employees instantly by skill, department, location, or any custom field." },
            ].map((feature, i) => (
              <motion.div
                key={i}
                {...fadeUp(i * 0.1)}
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-10 space-y-32">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            <div className="lg:w-1/2">
              <motion.h2 {...fadeUp()} className="text-3xl lg:text-4xl font-black text-slate-900 mb-6 tracking-tight">Seamless Onboarding Experience</motion.h2>
              <motion.p {...fadeUp(0.1)} className="text-lg text-slate-500 leading-relaxed mb-8">
                Make a great first impression. Automate the collection of employee documents, digital signatures, and asset assignments before they even start their first day.
              </motion.p>
              <ul className="space-y-4">
                {[
                  "Customizable onboarding checklists",
                  "Digital document signing",
                  "Automated IT provisioning alerts"
                ].map((text, i) => (
          ...
          <div className="flex flex-col lg:flex-row-reverse items-center gap-16">
            <div className="lg:w-1/2">
              <motion.h2 {...fadeUp()} className="text-3xl lg:text-4xl font-black text-slate-900 mb-6 tracking-tight">Organogram & Hierarchy</motion.h2>
              <motion.p {...fadeUp(0.1)} className="text-lg text-slate-500 leading-relaxed mb-8">
                Visualize your entire organization structure instantly. Understand reporting lines, department sizes, and structural gaps with our interactive org chart tool.
              </motion.p>
              <ul className="space-y-4">
                {[
                  "Auto-updating organization charts",
                  "Drill-down by department or branch",
                  "Export structure for presentations"
                ].map((text, i) => (
                  <motion.li key={i} {...fadeUp(0.2 + (i * 0.1))} className="flex items-center gap-3">
                    <CheckCircle className="text-blue-500 w-5 h-5 shrink-0" />
                    <span className="text-slate-700 font-medium">{text}</span>
      ...
      <section className="relative overflow-hidden bg-white py-24 border-t border-slate-100">
        ...
        <div className="max-w-4xl mx-auto px-6 lg:px-10 text-center relative">
          <motion.h2 {...fadeUp()} className="text-4xl md:text-5xl font-black text-slate-900 mb-6 tracking-tight">
            Ready to organize your workforce?
          </motion.h2>
          <motion.p {...fadeUp(0.1)} className="text-xl text-slate-500 mb-10">
            Join modern HR teams who use Zenova to manage their employee data securely and efficiently.
          </motion.p>
