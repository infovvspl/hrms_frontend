      ...
      <div className="space-y-6 max-w-7xl mx-auto py-4 px-2 sm:px-4 animate-fadeIn bg-slate-50/50 rounded-[2.5rem]">
        ...
        <div className="bg-white border border-slate-200/50 rounded-3xl p-6 md:p-8 shadow-sm flex flex-col md:flex-row justify-between items-start md:items-center gap-6 relative overflow-hidden">
          ...
          <div className="space-y-1.5 relative z-10 text-left">
            ...
            <h1 className="text-2xl md:text-3xl font-extrabold text-slate-800 tracking-tight mt-1.5 animate-fadeIn">
              Month-Wise Attendance Workspace
            </h1>
            <p className="text-slate-400 text-xs font-semibold">
              Track workforce monthly attendance summaries, print checklists, and audit timesheets.
            </p>
          </div>
          ...
          <div className="flex gap-3 shrink-0 z-10 w-full md:w-auto">
            <a 
              href="/daily-tracking"
              className="px-5 py-3 bg-gradient-to-r from-blue-600 to-indigo-650 hover:scale-[1.02] duration-350 text-white rounded-2xl text-xs font-black transition flex items-center justify-center gap-2 shadow-md cursor-pointer shadow-blue-200"
            >
              Open Daily Tracking Portal <FaArrowRight />
            </a>
          </div>
        </div>
