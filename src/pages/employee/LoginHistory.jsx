      ...
      <div className="space-y-6 max-w-7xl mx-auto py-2">
          ...
          <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div className="space-y-1">
              ...
              <p className="text-slate-300 text-xs font-semibold">
                Track your login activity, active sessions, and client devices.
              </p>
            </div>
            <button
        ...
        {lastLogin && (
          <div className="bg-blue-50/50 border border-blue-100 rounded-3xl p-4 flex items-center gap-4">
            <div className="w-10 h-10 rounded-xl bg-blue-100/50 border border-blue-200 flex items-center justify-center shrink-0">
              <LogIn size={18} className="text-blue-600" />
            </div>
            <div>
              <p className="text-[9px] text-slate-400 font-black uppercase tracking-wider mb-0.5">Last Active Login</p>
              <p className="text-xs text-slate-700 font-bold">
                {formatDate(lastLogin.login_at)}
                {lastLogin.ipaddress && (
                  <span className="text-slate-400 font-medium ml-3">
                    from IP: {lastLogin.ipaddress}
                  </span>
                )}
              </p>
            </div>
              ...
              <table className="w-full text-left border-collapse">
                ...
                <tbody className="divide-y divide-slate-100">
                  {paginated.map((rec, i) => (
                    ...
                    >
                      {/* # */}
                      <td className="px-5 py-4 text-[10px] text-slate-400 font-bold whitespace-nowrap">
                      ...
                      {/* Device Info */}
                      <td className="px-5 py-4 whitespace-nowrap text-slate-500 max-w-[120px] truncate" title={rec.device_info}>
                        {rec.device_info || "—"}
                      </td>
